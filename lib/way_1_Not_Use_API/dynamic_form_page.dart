...
class _DynamicFormState extends State<DynamicForm> {
  ...
  getFromJson() async {
    String data = await DefaultAssetBundle.of(context)
        .loadString("lib/way_1_Not_Use_API/assets/json/form.json");
    final jsonResult = jsonDecode(data);

    setState(() {
      jsonResult.forEach(
              (element) => formResponse.add(FormModel.fromJson(element)));
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Call a function to post form values here
            postFormValues();
          },
          child: Text('Submit'),
        ),
  ...
  void postFormValues() {
    ...
    var formData = {
      ...
      'dropdownValue': dropdownvalue?.optionValue,
